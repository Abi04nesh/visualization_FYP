...
#                 columns_to_keep = consolidated_df.columns
#                 return consolidated_df, columns_to_keep
#             else:
...
#     st.write("### Cleaned and Consolidated Table", cleaned_df)
#     return cleaned_df
...
#     st.sidebar.subheader("Select Chart to View")
#     chart_options = [
...
#         if chart_option == "Bar Chart" and (len(categorical_columns) < 1 or len(numeric_columns) < 1):
#             st.sidebar.button(chart_option, disabled=True)
#             if st.sidebar.button(f"Details - {chart_option}"):
#                 st.warning("Bar Chart requires at least 1 categorical column and 1 numeric column.")
#         elif chart_option == "Line Chart" and (len(categorical_columns) < 1 or len(numeric_columns) < 1):
#             st.sidebar.button(chart_option, disabled=True)
#             if st.sidebar.button(f"Details - {chart_option}"):
#                 st.warning("Line Chart requires at least 1 categorical column and 1 numeric column.")
#         elif chart_option == "Pie Chart" and len(categorical_columns) < 1:
#             st.sidebar.button(chart_option, disabled=True)
#             if st.sidebar.button(f"Details - {chart_option}"):
#                 st.warning("Pie Chart requires at least 1 categorical column.")
#         elif chart_option == "Scatter Plot" and len(numeric_columns) < 2:
#             st.sidebar.button(chart_option, disabled=True)
#             if st.sidebar.button(f"Details - {chart_option}"):
#                 st.warning("Scatter Plot requires at least 2 numeric columns.")
#         elif chart_option == "Box Plot" and (len(categorical_columns) < 1 or len(numeric_columns) < 1):
#             st.sidebar.button(chart_option, disabled=True)
#             if st.sidebar.button(f"Details - {chart_option}"):
#                 st.warning("Box Plot requires at least 1 categorical column and 1 numeric column.")
#         elif chart_option == "Correlation Heatmap" and len(numeric_columns) <= 1:
#             st.sidebar.button(chart_option, disabled=True)
#             if st.sidebar.button(f"Details - {chart_option}"):
#                 st.warning("Correlation Heatmap requires at least 2 numeric columns.")
#         elif chart_option == "Histogram" and len(numeric_columns) < 1:
#             st.sidebar.button(chart_option, disabled=True)
#             if st.sidebar.button(f"Details - {chart_option}"):
#                 st.warning("Histogram requires at least 1 numeric column.")
#         elif chart_option == "Bubble Chart" and len(numeric_columns) < 3:
#             st.sidebar.button(chart_option, disabled=True)
#             if st.sidebar.button(f"Details - {chart_option}"):
#                 st.warning("Bubble Chart requires at least 3 numeric columns.")
#         elif chart_option == "Sunburst Chart" and len(categorical_columns) < 2:
#             st.sidebar.button(chart_option, disabled=True)
#             if st.sidebar.button(f"Details - {chart_option}"):
#                 st.warning("Sunburst Chart requires at least 2 categorical columns.")
#         elif chart_option == "Treemap" and len(categorical_columns) < 2:
#             st.sidebar.button(chart_option, disabled=True)
#             if st.sidebar.button(f"Details - {chart_option}"):
#                 st.warning("Treemap requires at least 2 categorical columns.")
#         elif chart_option == "Funnel Chart" and (len(categorical_columns) < 1 or len(numeric_columns) == 0):
#             st.sidebar.button(chart_option, disabled=True)
#             if st.sidebar.button(f"Details - {chart_option}"):
#                 st.warning("Funnel Chart requires at least 1 categorical column and 1 numeric column.")
#         elif chart_option == "Density Heatmap" and len(numeric_columns) < 2:
#             st.sidebar.button(chart_option, disabled=True)
#             if st.sidebar.button(f"Details - {chart_option}"):
#                 st.warning("Density Heatmap requires at least 2 numeric columns.")
#         elif chart_option == "Violin Plot" and (len(categorical_columns) < 1 or len(numeric_columns) < 1):
#             st.sidebar.button(chart_option, disabled=True)
#             if st.sidebar.button(f"Details - {chart_option}"):
#                 st.warning("Violin Plot requires at least 1 categorical column and 1 numeric column.")
#         elif chart_option == "Strip Plot" and (len(categorical_columns) < 1 or len(numeric_columns) < 1):
#             st.sidebar.button(chart_option, disabled=True)
#             if st.sidebar.button(f"Details - {chart_option}"):
#                 st.warning("Strip Plot requires at least 1 categorical column and 1 numeric column.")
#         elif chart_option == "Facet Grid" and (len(categorical_columns) < 1 or len(numeric_columns) < 1):
#             st.sidebar.button(chart_option, disabled=True)
#             if st.sidebar.button(f"Details - {chart_option}"):
#                 st.warning("Facet Grid requires at least 1 categorical column and 1 numeric column.")
#         else:
#             if st.sidebar.button(chart_option):
#                 generate_chart(chart_option, df, numeric_columns, categorical_columns)
